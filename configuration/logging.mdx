...
greed can track a wide range of activities. You can assign different categories to different channels to keep things organized.
...
For specific moderation actions (bans, kicks, mutes), you can use a dedicated setting to define the log channel.
